...
if __name__ == "__main__":
    ...
    #Amit   
#    c.printZerodhaAccess_token('j9mUiYE2AorfGzjanUnM8cM6B866Wtlt')   
    ...
    if getDataFromZerodha == 1:
        ...
        while (c.in_between(datetime.now().time(), time(6,00), time(15,40))):
...
#        quandlQuotes = c.module_Get_Live_Data_From_Google.getAllQuotesFromQuandl(stock_names)
        ...
        while (c.in_between(datetime.now().time(), time(8,40), time(15,40))):
